export const provinceSlugToCode: Record<string, number> = {
...
export const provinceCodeToSlug: Record<number, string> =
  Object.fromEntries(Object.entries(provinceSlugToCode).map(([k, v]) => [v, k]))
