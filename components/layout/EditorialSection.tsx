    ...
    <section className="max-w-5xl mx-auto px-3 sm:px-4 pb-10 sm:pb-14">
      <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
        <div className="max-w-2xl">
          <h2 className="text-base font-semibold text-gray-900 dark:text-white mb-3">Petrolistan Nedir?</h2>
        ...
        <div className="mt-8 pt-5 border-t border-gray-100 dark:border-gray-800 flex flex-wrap items-center gap-x-5 gap-y-2">
